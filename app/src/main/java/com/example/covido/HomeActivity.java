...
//     <----  finding all the variables here !!! ---->
...
//     <----  Creating india button here for state  & city data here !!! ---->
    ...
    private void openMainActivity() {
        Intent indiaIntent = new Intent(this, MainActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            //     <---- the Declaring object data here  !!! ---->
    ...
    //     <---- Onclick to the affected countries  !!! ---->
